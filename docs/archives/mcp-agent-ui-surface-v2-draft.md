...
> Archived note:
> This draft is kept for design history only.
> The active MCP contract now lives in [../mcp.md](../mcp.md), [../mcp_end_state.md](../mcp_end_state.md), and [../mcp_end_state_schema.md](../mcp_end_state_schema.md).
...
如果本草案落地，应直接替换 [../mcp_end_state.md](../mcp_end_state.md) 和 [../mcp_end_state_schema.md](../mcp_end_state_schema.md) 中与 handle identity、widget discovery 相关的契约，而不是作为并行兼容层存在。
...
1. 更新 [../mcp_end_state.md](../mcp_end_state.md) 与 [../mcp_end_state_schema.md](../mcp_end_state_schema.md)，统一为最终 V2 契约。
